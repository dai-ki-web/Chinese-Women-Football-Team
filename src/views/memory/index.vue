<template>
  <div class="memory" id="memory">
    ...
    <el-image :src="img25" lazy></el-image>
    <section class="section">
    ...
    <section class="section">
      ...
      <p>
        几十年间，和水指导并肩作战的人从与她同龄的队友变成了晚她一辈的队员们，但尽管相隔多年，铿锵玫瑰的基因一直流淌在女足姑娘的血液里。女足、女排、跳水、乒乓球、短道速滑，尽管项目不同，传承却是一样的。弦歌不辍，薪火相传，这是中国体育事业的底色。
      </p>
    </section>
    31
    <section class="section">
